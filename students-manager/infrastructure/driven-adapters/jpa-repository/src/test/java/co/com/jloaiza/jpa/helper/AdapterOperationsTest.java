package co.com.jloaiza.jpa.helper;

import co.com.jloaiza.jpa.entities.student.StudentRepository;
import co.com.jloaiza.jpa.entities.student.StudentRepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    void setUp() {
        ...
        adapter = new StudentRepositoryAdapter(repository, objectMapper);
    }
